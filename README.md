...
* [Schema aware database transactions](kcrud-core/src/main/kotlin/kcrud/core/database/utils/TransactionWithContext.kt), allowing to execute concrete transactions per schema.
