...
public interface IEmploymentRepository {
     ...
     */
    public fun findAll(pageable: Pageable? = null): Page<EmploymentEntity>
     ...
     */
    public fun findById(employeeId: Uuid, employmentId: Uuid): EmploymentEntity?
     ...
     * @return List of [EmploymentEntity] entities.
     */
    public fun findByEmployeeId(employeeId: Uuid): List<EmploymentEntity>
     ...
     */
    public fun create(employeeId: Uuid, employmentRequest: EmploymentRequest): Uuid
     ...
     */
    public fun update(employeeId: Uuid, employmentId: Uuid, employmentRequest: EmploymentRequest): Int
     ...
     */
    public fun delete(employmentId: Uuid): Int
     ...
     * @return The number of delete records.
     */
    public fun deleteAll(employeeId: Uuid): Int
     ...
     */
    public fun count(employeeId: Uuid? = null): Int
}
