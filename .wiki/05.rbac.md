...
must inherit from [BaseRbacDto](../kcrud-access/src/main/kotlin/kcrud/access/rbac/model/base/BaseRbacDto.kt), and call the anonymize function accordingly based on the defined field rules,
