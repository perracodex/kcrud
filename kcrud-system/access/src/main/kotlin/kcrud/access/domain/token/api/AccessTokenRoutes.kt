...
package kcrud.access.domain.token.api

import io.ktor.server.routing.*
import kcrud.access.domain.token.annotation.TokenApi
import kcrud.access.domain.token.api.operate.createTokenRoute
import kcrud.access.domain.token.api.operate.refreshTokenRoute
